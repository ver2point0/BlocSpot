...
public class Constants {
    ...
    public static final String ALL_PLACE_TYPES = "&types=accounting|airport|amusement_park|aquarium|" +
            "art_gallery|atm|bakery|bank|bar|beauty_salon|bicycle_store|book_store|bowling_alley|" +
            "bus|station|cafe|campground|car_dealer|car_rental|car_repair|car_wash|casino|cemetery|" +
            ...
            "parking|pet_store|pharmacy|physiotherapist|place_of_worship|plumber|police|post_office|" +
